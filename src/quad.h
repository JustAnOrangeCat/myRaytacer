...
class quad : public hittable
{
    public:
        ...
        virtual bool is_interior(double a, double b, hit_record& rec) const
        {
            ...
            //Given the hitpoint in plane coordinates, return false if it is outside the primitive.
...
{
    //Returns 3d box. that contains opposite vertices a and b.

    auto sides = make_shared<hittable_list>();

    //construct the two oppsite vertices with min and max coordinates
    auto min = point3(std::fmin(a.x(), b.x()), std::fmin(a.y(), b.y()), std::fmin(a.x(), b.z()));
