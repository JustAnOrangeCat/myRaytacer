...
class camera{
      public:
        ...
        int max_depth = 10; //Maximum number of ray bouncs into the scene
        ...
        double defocus_angle = 0; //variation angle of rays through each pixels
        double focus_dist = 10; //distance from llokfrom to perfect focus
      ...
      private:
        ...
        void initialize() {
            ...
            //Calculate u, v, w basis vector
            w = unit_vector(lookfrom - lookat);
            u = unit_vector(cross(vup,w));
            v = cross(w, u);

            // Calculate the vectors across the horizontal and down the vertical viewport edges.
            auto viewport_u = viewport_width * u; //horizontal vector
            auto viewport_v = viewport_height * -v; //vertical vector
        ...
        vec3 sample_square() const{
            //returns a vector to a random point to a [-0.5,-0.5], [+0.5, +0.5] unit square
            return vec3(random_double() - 0.5, random_double() - 0.5, 0);
        }

        point3 defocus_disk_sample() const
        {
            //return random points in defocus disk
        ...
        color ray_color(const ray& r, int depth, const hittable& world){
            ...
            //if the ray hits nothing return black color
